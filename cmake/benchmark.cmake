...
option(BENCHMARK_PLOTS "Enable plotting of benchmark results" ON)
...
if (PYTHON)
    ...
    else (BENCHMARK_PLOTS)
        message(STATUS "Disabled benchmark plots")
    endif (BENCHMARK_PLOTS)
else (PYTHON)
...
macro(add_benchmark TARGET_BM)
    ...
    if (BENCHMARK_PLOT)
        ...
        set_tests_properties(${TARGET_BM}_plot PROPERTIES DEPENDS ${TARGET_BM} COST 50)
    else (BENCHMARK_PLOT)
        add_test(NAME ${TARGET_BM} COMMAND ${TARGET_BM})
    endif (BENCHMARK_PLOT)
    set_tests_properties(${TARGET_BM} PROPERTIES RUN_SERIAL ON COST 100)
endmacro()
